package com.erivan.parkingcontrol.models;
...
public class ParkingSpotModel implements Serializable {
    ...
    private UUID id; //UUID bom para arquitetura distribuidas, identificadores unicos e universais
    ...
    private LocalDateTime registrationDate; //data de registro do carro na portaria
